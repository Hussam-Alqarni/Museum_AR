...
window.translations = {
  ar: {
    ...
    "site_about": "متحف افتراضي بتقنيات حديثة: <strong>واقع معزّز (AR)</strong> ومجسمات <strong>ثلاثية الأبعاد (3D)</strong>. يُفضّل استخدام <strong>هاتف أندرويد</strong> لضمان أفضل جودة للتجربة.",
    "no_marker_btn": "تجاوز الماركرات وعرض التحف",
    "picker_title": "اختر قطعة لعرضها",
    "picker_close": "إغلاق",
  ...
  en: {
    ...
    "site_about": "A virtual museum powered by modern technology: <strong>Augmented Reality (AR)</strong> and <strong>3D models</strong>. An <strong>Android phone</strong> is recommended for the best experience.",
    "no_marker_btn": "Skip Markers & View Artifacts",
    "picker_title": "Choose an artifact to view",
    "picker_close": "Close",
